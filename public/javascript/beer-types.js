...
angular.module('beerApp')
	.factory('beerFactory', function(){
		...
		var avery = new Brewery('Avery Brewing Company', 'Boulder', '4910 Nautilus Ct.', 'http://averybrewing.com', ['strongly flavored Ales', 'lots of hops, malt, AND FLAVOR', 'high ABV'], [ ipa, wheat, brown, stout, pilsner, porter, amber], 'avery')
		var leftHand = new Brewery('Left Hand Brewery', 'Longmont', '1265 Boston Ave.', 'http://lefthandbrewing.com', ['Awesome labels'], [ipa, stout, paleAle, pilsner, porter], 'lefthand')
		...
		var fate = new Brewery('FATE Brewing Company', 'Boulder', '1600 38th St.', 'http://fatebrewingcompany.com', ['Creating something different'], [ipa, stout, wheat, pilsner], 'fate')
		...
		var upslope = new Brewery('Uplsope Brewing Company', 'Boulder', '1898 S Flatiron Ct.', 'http://upslopebrewing.com', ['cool cans', 'Beers made in small batches'], [paleAle, ipa, brown, sour, stout], 'upslope')
		var asher = new Brewery('Asher Brewing Comapny', 'Boulder', '4699 Nautilus Ct.', 'http://asherbrewing.com', ["Colorado's First all Organic Brewery"], [ipa, amber, wheat], 'asher')
		...
		var newPlanet= new Brewery('New Planet', 'Boulder', '6560 Odell Place, Unit D', 'http://www.newplanetbeer.com', ['only brewery in CO with all Gluten Free beers'], [paleAle, wheat, fruit], 'newplanet')
